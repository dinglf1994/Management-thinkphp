...
<body>
    <div>
	    <div class="crumb-list"><i class="icon-font"> </i><a href="/new_new_management_system/index.php/Home/Clamanage/../Index/main">首页 </a><span class="crumb-step">&gt;</span><span class="crumb-name">添加教室信息</span></div>
	    <form action="/new_new_management_system/index.php/Home/Clamanage/addclasroom" method="post"id="checkname">
