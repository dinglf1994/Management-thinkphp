...
<div class="tab-content" id="tab2">
        <div class="crumb-list"><i class="icon-font"> </i><a href="/new_new_management_system/index.php/Home/Currmanage/../Index/main">首页 </a><span class="crumb-step">&gt;</span><span class="crumb-name">添加课程信息</span></div>
    <form action="/new_new_management_system/index.php/Home/Currmanage/add" method="post" id="checkname">
