...
<div class="pageColumn">
	<form method="post" action="/new_new_management_system/index.php/Home/Stumanage/search" id="search">
	...
	</form><div style="margin-left:90%"><a href="/new_new_management_system/index.php/Home/Stumanage/add"><h2><font size="3" color="green">添加学生信息</font></h2></a></div>
<div class="pageButton"></div>
	...
	<table>
      ...
      <tbody>
          ...
          <td><a href="/new_new_management_system/index.php/Home/Stumanage/read/id/<?php echo ($vo['id']); ?>"><font color="green"><?php echo ($vo['name']); ?></font></a></td>
          <td><?php echo ($vo['sex']); ?></td>
		  <td><?php echo ($vo['academy']); ?></td>
		  <td><?php echo ($vo['speciality']); ?></td>
		  <td>
  			<a href="/new_new_management_system/index.php/Home/Stumanage/edit/id/<?php echo ($vo['id']); ?>" title="编辑"><img src="/new_new_management_system/Public/Images/admin/icons/pencil.png" alt="编辑" /></a>
  			<a href="/new_new_management_system/index.php/Home/Stumanage/delete/id/<?php echo ($vo['id']); ?>" title="删除"><img src="/new_new_management_system/Public/Images/admin/icons/cross.png" alt="删除" /></a>
		</td>
