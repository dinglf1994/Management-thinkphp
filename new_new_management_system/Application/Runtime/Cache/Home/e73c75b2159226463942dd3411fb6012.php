...
<div id="contentWrap">
    ...
    <div class="pageColumn"><form method="post" action="/new_new_management_system/index.php/Home/Tecmanage/search" id="search">
        按照Id查询教师<input type="text" id="sid" name="searchid"/> 按照姓名查询教师 <input type="text" id="sname" name="searchname"/>
        <input class="btn btn-primary btn6 mr10" type="submit" value="查询" /><div style="margin-left:90%"><a href="/new_new_management_system/index.php/Home/Tecmanage/add"><h2><font size="3" color="green">添加教师信息</font></h2></a></div>
        ...
        <table>
            ...
            <?php if(is_array($teacher_list)): $i = 0; $__LIST__ = $teacher_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php $ac=$vo['speciality']; switch($ac){ case 1: echo "计算机科学与技术"; break; case 2: echo "自动化"; break; case 3: echo "测控技术与仪器"; break; case 4: echo "信息工程"; break; case 5: echo "化学工程"; break; case 6: echo "应用化学"; break; case 7: echo "高分子材料科学与工程"; break; case 8: echo "经济管理"; break; }?>
                    </td>
                    ...
                    <!--<td><a href="/new_new_management_system/index.php/Home/Tecmanage/read/id/<?php echo ($vo['id']); ?>"><?php echo ($vo['title']); ?></a></td>-->
                    <td>
                        <a href="/new_new_management_system/index.php/Home/Tecmanage/edit/id/<?php echo ($vo['id']); ?>" title="编辑"><img src="/new_new_management_system/Public/Images/admin/icons/pencil.png" alt="编辑" /></a>
                        <a href="/new_new_management_system/index.php/Home/Tecmanage/delete/id/<?php echo ($vo['id']); ?>" title="删除"><img src="/new_new_management_system/Public/Images/admin/icons/cross.png" alt="删除" /></a>
                    </td>
