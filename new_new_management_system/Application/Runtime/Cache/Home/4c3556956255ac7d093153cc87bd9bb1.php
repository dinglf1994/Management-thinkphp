...
<html>
    ...
    <body>
        <div class="tab-content">
            <div class="crumb-list"><i class="icon-font"> </i><a href="/new_new_management_system/index.php/Home/Sysmessage/../Index/main">首页 </a><span class="crumb-step">&gt;</span><span class="crumb-name">查看公告信息</span></div>

          <form action="/new_new_management_system/index.php/Home/Sysmessage/update/id/<?php echo ($Id); ?>" method="post">
