...
<div class="tab-content" id="tab2">
    <div class="crumb-list"><i class="icon-font"> </i><a href="/new_new_management_system/index.php/Home/Currmanage/../Index/main">首页 </a><span class="crumb-step">&gt;</span><span class="crumb-name">编辑课程信息</span></div>

    <form action="/new_new_management_system/index.php/Home/Currmanage/update/id/<?php echo ($Id); ?>" method="post"id="checkname">
        <table class="insert-tab" width="100%">
            ...
            <tr>
                <th></th>
          <td>
              <input class="btn btn-primary btn6 mr10"onClick="return check()" type="submit" value="确认修改" />
